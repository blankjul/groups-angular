import {Component, Input, OnInit, AfterViewChecked, AfterContentInit, AfterViewInit} from "@angular/core";
...
export class ResultComponent extends AbstractComponent implements OnInit{
  ...
  public toogle(s: Solution) {
    if (this.resultsToShow.has(s)) this.resultsToShow.delete(s);
    else this.resultsToShow.add(s);
  }
